...
MyClass::Locate() const {
    ...
    cin >> seconds;
    cout << degrees << " degrees, " << minutes << ", " << seconds << " seconds = "
         << float(degrees + ((minutes + seconds / 60.0) / 60.0)) << " degrees\n";
}
...
MyClass::TimeConverter() const {
    ...
    cout << void_seconds << " seconds = " << days << " days, " << hours << " hours, " << minutes << " minutes, "
         << seconds << " seconds\n";
}
