...
public:
    // constructors & destructor
    Gunslinger(string firstName = "NoFirstName", string lastName = "NoLastName", double time = 0,
               int Rifle = 0)  // overload explicit base constructor
...
public:
    // constructors & destructor
    BadDude(string firstName = "NoFirstName", string lastName = "NoLastName", double time = 0,
            int Rifle = 0) // overload explicit base constructor
            : Person(firstName, lastName), Gunslinger(firstName, lastName, time, Rifle),
